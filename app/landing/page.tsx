...
export default function LandingPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // For now, accept any credentials and set auth token
    localStorage.setItem('beverage_pos_auth', 'true')
    router.push("/")
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-blue-100/30 rounded-full animate-pulse opacity-60"></div>
        <div className="absolute bottom-1/3 right-1/4 w-24 h-24 bg-purple-100/20 rounded-full animate-pulse opacity-40 animation-delay-700"></div>
        <div className="absolute top-2/3 left-1/6 w-20 h-20 bg-emerald-100/25 rounded-full animate-pulse opacity-50 animation-delay-1000"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-12 animate-fade-in">
          <div className="flex items-center justify-center mb-6">
            <div className="p-6 bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg hover:shadow-xl transition-all duration-500">
              <svg width="120" height="20" viewBox="0 0 70 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-8 w-auto text-gray-800">
          ...
          <h1 className="text-3xl font-light text-gray-900 mb-2">Knotting Hill Place</h1>
          <p className="text-gray-600 text-sm">Premium beverage management system</p>
        </div>

        {/* Login Form */}
        <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-500 animate-slide-up">
          <CardContent className="p-8">
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 h-12 border-gray-200 bg-gray-50/50 focus:bg-white transition-all duration-200 rounded-xl"
                    required
                  />
                </div>
                <div className="relative">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-900 hover:to-black text-white rounded-xl font-medium transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                {isLoading ? (
            ...
            <div className="mt-6 text-center">
              <p className="text-xs text-gray-500">
                Secure access to your beverage management system
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="text-center mt-8 opacity-60">
          <p className="text-xs text-gray-500">
            © 2024 Knotting Hill Place. All rights reserved.
          </p>
        </div>
      </div>
